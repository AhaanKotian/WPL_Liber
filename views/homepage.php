...
<html>
    ...
    <body>
        <header>
            ...
            <a href="/WPL_Liber/views/driverui.php"><button class="driverbtn" >
              Are you a Driver?</button></a>
            ...
            <?php
              ...
              if (isset($_POST['submit_sigin'])) 
              {
                ...
                elseif (filter_var($email, FILTER_VALIDATE_EMAIL) == true && $pwd) 
                {
                  ...
                  $SQLstring = "SELECT * from rider where email = '$email'";
                  ...
                  { 
                    ...
                    echo "<h1>The log-in is success. You will be directed to the booking page shortly.<h1>"; 
                    sleep(3);
            ...
            <dialog class="modal" id="modal">
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" class="form_container" method="POST">
                    ...
                    <div class="input_container">
                      ...
                      <input type="submit" name="submit_sigin" class="sign-in_btn" value="Sign In">
                      </button>
                    </div>
            ...
            <?php
              ...
              if (isset($_POST['submit_signup'])) 
              {
                ...
                echo "Please fill in a valid e-mail address.<br>";
                  ...
                  $SQLstring = "SELECT email from rider where email = '$email';";
                  $queryResult = mysqli_query($conn, $SQLstring)
                ...
                if ($count == 5) 
                {
                  $query = "INSERT INTO rider ( name, email, password) VALUES  ('$name','$email','$pwd');";
            ...
            <dialog class="modal1" id="modal1">
              <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" class="form_container" method="POST">
                  ...
                  <div class="input_container">
                    ...
                    <input type="submit" name = "submit_signup" class="sign-up_btn" value="Sign-up"/>
                  </div>
            ...
            <section class="home">
                <div class="textbox">
                    ...
                    <button class="ridenow" onclick="window.location.href='ridenow.php'" >
                        <span class="circle" aria-hidden="true">
                        <span class="icon arrow"></span>
                        </span>
                        <span class="button-text">Ride now</span>
                    </button>    
                </div>
                <div class="imgbox">
